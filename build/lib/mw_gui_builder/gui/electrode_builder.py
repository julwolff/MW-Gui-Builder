...
class GuiElectrodeBuilder:
    ...
    def __init__(self, master):
        ...
        ttk.Label(self.frame, text="Coordinate file:").grid(row=0, column=0, columnspan=2)
        
        self.filename_entry = ttk.Entry(self.frame, width=40)
    ...
    def browse_file(self):
        """Open a file dialog to select the coordinate file."""
